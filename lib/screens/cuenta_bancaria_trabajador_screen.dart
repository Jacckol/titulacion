...
class CuentaBancariaTrabajadorScreen extends StatefulWidget {
  ...
  @override
  State<CuentaBancariaTrabajadorScreen> createState() => _CuentaBancariaTrabajadorScreenState();
}

class _CuentaBancariaTrabajadorScreenState extends State<CuentaBancariaTrabajadorScreen> {
  ...
  Future<void> _guardar() async {
    ...
    try {
      ...
      if (qrFile != null) {
        final req = http.MultipartRequest("POST", Uri.parse("$baseUrl/perfil/qr"));
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("✅ Cuenta bancaria guardada"), backgroundColor: Colors.green),
      );
          ...
          : Padding(
              ...
              child: ListView(
                children: [
                  ...
                  TextField(controller: tipoCtrl, decoration: const InputDecoration(labelText: "Tipo de cuenta (ahorros/corriente)")),
                  TextField(controller: numeroCtrl, decoration: const InputDecoration(labelText: "Número de cuenta")),
                  TextField(controller: titularCtrl, decoration: const InputDecoration(labelText: "Titular")),
                  ...
                  if (qrCuentaUrlActual != null) ...[
                    OutlinedButton.icon(
                      onPressed: () => _verImagenDialog(titulo: "Mi QR actual", url: qrCuentaUrlActual!),
                  ...
                  OutlinedButton.icon(
                    ...
                    label: Text(qrFile == null ? "Subir/actualizar QR (opcional)" : "QR seleccionado: ${qrFile!.name}"),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    child: Text(guardando ? "Guardando..." : "Guardar", style: const TextStyle(color: Colors.white)),
                  ),
                ],
              ),
            ),
